...
from libs.models import getModelType, getModelInfoTxt
import datetime
...
for i in range(nRun):
    ...
    ulogs.append([
        ...
        getModelInfoTxt(model_configs['name-model']),
        t_acc[0],
        model_configs['address-model']['type'],
        getModelInfoTxt(model_configs['address-model']),
        t_acc[1],
        model_configs['phone-model']['type'],
        getModelInfoTxt(model_configs['phone-model']),
        t_acc[2],
        cd_acc,
        sd_acc
    ])
