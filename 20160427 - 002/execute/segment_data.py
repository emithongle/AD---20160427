...
def saveTemplateResults(labels, acc, goodresults, badresults):
    ...
    _orgScore = ['%Name', '%NotName', '%Address', '%NotAddress', '%Phone', '%NotPhone']
    ...
    titleG = ['TestCase', 'Top', 'Name', 'Address', 'Phone', 'Corrected',
            ...
            ['PrepName']+ _orgScore + featureNames + _score + \
            ['PrepAddress']+ _orgScore + featureNames + _score +\
            ['PrepPhone']+ _orgScore + featureNames + _score
